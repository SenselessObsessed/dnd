export default class Trello {
  ...
  bindToDOM() {
    ...
    document.addEventListener("mousedown", (e) => {
      ...
      const { width, height } = this.draggedEl.getBoundingClientRect();
  ...
  onClick(event) {
    ...
    if (event.target.classList.contains("add-column")) {
      ...
      event.target.closest(".col").querySelector(".add-btn").style.display =
        "block";
  ...
  saveToLocalStorage() {
    const firstColumnItems = Array.from(
      document
        .querySelector(".first__column")
        .querySelector(".column")
        .querySelectorAll(".column-item"),
    );
    const secondColumnItems = Array.from(
      document
        .querySelector(".second__column")
        .querySelector(".column")
        .querySelectorAll(".column-item"),
    );
    const thirdColumnItems = Array.from(
      document
        .querySelector(".third__column")
        .querySelector(".column")
        .querySelectorAll(".column-item"),
    );
